...
import { useRequestChangePasswordCode, useVerifyResetCode } from "../../api";
...
export function ChangePasswordCodeStep({ email, onCodeVerified }: Props) {
      ...
      >
        ...
        <View className="mb-8 items-center">
          <Text className="text-3xl font-bold text-textPrimary">
            {messages.auth.changePassword.verifyTitle}
          </Text>
          <Text className="text-base text-textSecondary mt-2 text-center">
            {messages.auth.changePassword.verifySubtitle}
          </Text>
        ...
        >
          {messages.auth.changePassword.verifySubmit}
        </Button>
